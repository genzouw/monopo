...
const FEATURE_TOGGLES: Array<{
  ...
  {
    key: 'progressiveTax',
    label: '🏛️ しゃかいぜいきん（累進課税）',
    description:
      'もちものがおおいプレイヤーはGOをとおったとき、おきゃくさん（おきゃく）ぜいきんがかかるよ。かねもちほどたくさんはらうしくみだよ',
  },
  {
    key: 'basicIncome',
    label: '🤝 みんなのてあて（ベーシックインカム）',
    description:
      'もちものがすくないプレイヤーはGOをとおったとき、よぶんにおこづかいがもらえるよ。みんながたのしくあそべるようにするしくみだよ',
  },
];
const DEFAULT_NAMES = [
  'プレイヤー1',
