...
describe('calculateRent', () => {
  it('未所有の場合は0を返す', () => {
    ...
    expect(calculateRent('mediterranean', states, BOARD_SPACES, [3, 4])).toBe(0)
  })
  ...
  it('基本家賃を返す', () => {
    ...
    expect(calculateRent('mediterranean', states, BOARD_SPACES, [3, 4])).toBe(2)
  })
  ...
  it('カラーグループ独占時は2倍の家賃', () => {
    ...
    expect(calculateRent('mediterranean', states, BOARD_SPACES, [3, 4])).toBe(4)
  })
...
describe('canMortgage', () => {
  ...
  it('グループに家があれば抵当に入れられない', () => {
    ...
    expect(canMortgage('mediterranean', 'p1', states, BOARD_SPACES)).toBe(false)
  })
})
...
describe('canSellHouse', () => {
  it('家がある場合は売れる（均等ルール満たすとき）', () => {
    ...
    expect(canSellHouse('mediterranean', 'p1', states, BOARD_SPACES)).toBe(true)
  })
