...
### GitHub Secret Scanning と Push Protection の推奨

リポジトリ管理者に対して、GitHub ネイティブの **Secret Scanning** および **Push Protection** をリポジトリ設定画面から有効化することを強く推奨します。これにより、ローカルのチェックをすり抜けたシークレットも push 時にサーバー側でブロックされます。
