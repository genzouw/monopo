...
GitHub Actionsを用いたAIツール(Qodo Merge, 等) の統合においても、すべてのサードパーティ製 Action は mutable なタグ(`@v1`, `@main` など) ではなく、正確な 40文字のコミット SHA にピン留めすることが義務付けられています。これにより、ツールに悪意のあるコードが紛れ込むことや、プロンプトインジェクション、データ漏洩などの AI 固有のセキュリティリスクを低減しています。
